    ...
    return (
        <div className="mx-auto ">
            <motion.svg
                ...
                className=" hidden  md:block top-64 md:top-56 md:left-1/3 absolute " xmlns="http://www.w3.org/2000/svg" width="450" height="370" viewBox="0 0 538 475" fill="none">
            ...
            <motion.svg
                ...
                className=" md:hidden z-10 top-64 md:top-56 md:left-1/3 absolute " xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 538 475" fill="none">
